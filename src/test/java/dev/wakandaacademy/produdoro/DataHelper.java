...
public class DataHelper {
    ...
    public static Usuario createUsuarioTeste() {
        return Usuario.builder().email("testeEmail@email.com").status(StatusUsuario.PAUSA_LONGA).idUsuario(UUID.randomUUID()).build();
    }
